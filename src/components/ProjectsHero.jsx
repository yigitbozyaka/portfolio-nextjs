export default function ProjectsHero({ repos }) {
    return (
        <div className="h-screen relative flex overflow-hidden flex-col text-left md:flex-row max-w-full justify-evenly mx-auto items-center z-0">
                    ...
                    <div className="w-screen flex-shrink-0 snap-start flex flex-col space-y-5 items-center justify-center p-20 md:p-44 h-screen" key={repo.id}>
                        <div className="bg-gray-900 w-96 h-64 rounded-lg">
                            ...
                            <div className="w-full h-52 flex flex-col justify-evenly items-center">
                                ...
                                >
                                    <h4 className="font-bold text-white text-xl">{repo.name}</h4>
                                    <p className="text-gray-400 my-8">{repo.description}</p>
                                </div>
                            </div>
                        </div>

                        <div className="flex flex-col items-start justify-start space-y-4 md:flex-row md:space-x-4 md:space-y-0">
                            <a
                                className="flex overflow-hidden items-center text-sm font-medium focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 bg-[#1E201E] text-white shadow hover:bg-[#1E201E]/90 h-9 px-8 py-2 max-w-52 whitespace-pre md:flex group relative w-full justify-center gap-2 rounded-md transition-all duration-300 ease-out hover:ring-2 hover:ring-black hover:ring-offset-2"
                                href={repo.html_url} target="_"
                            >
                                <span className="absolute right-0 -mt-12 h-32 w-8 translate-x-12 rotate-12 bg-white opacity-10 transition-all duration-1000 ease-out group-hover:-translate-x-40" />
                                <div className="flex items-center">
                                    <svg viewBox="0 0 438.549 438.549" className="w-4 h-4 fill-current">
                                    ...
                                    <span className="ml-1 text-white">View Code</span>
                                </div>
                            ...
                            {repo.homepage ? (
                                <a
                                    className="flex overflow-hidden items-center text-sm font-medium focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 bg-[#1E201E] text-white shadow hover:bg-[#1E201E]/90 h-9 px-4 py-2 max-w-52 whitespace-pre md:flex group relative w-full justify-center gap-2 rounded-md transition-all duration-300 ease-out hover:ring-2 hover:ring-black hover:ring-offset-2"
                                    href={repo.homepage} target="_"
                                >
                                    <span className="absolute right-0 -mt-12 h-32 w-8 translate-x-12 rotate-12 bg-white opacity-10 transition-all duration-1000 ease-out group-hover:-translate-x-40" />
                                    <div className="flex items-center">
                                        ...
                                        <span className="ml-1 text-white">View Demo</span>
                                    </div>
                                </a>) : (
                                <div
            ...
            <div className="w-full absolute top-[30%] bg-[#2c8dab]/5 left-0 h-[500px] -skew-y-12"></div>
        </div>
    )
}